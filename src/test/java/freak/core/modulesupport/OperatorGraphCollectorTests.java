...
public class OperatorGraphCollectorTests {
    ...
    public void testGetResourceDir() {
        URL dirURL = (new BitString(new MockSchedule())).getClass().getClassLoader().getResource("freak/module/graph/common/");
    }
    ...
    public void testGetGraph() {
        ...
        ModuleInfo[] graphs =  collector.getPredefinedGraphs("(1+1)EA.fop");
